...
import type { RestockItemDAO } from "@/modules/Restock/DAO/restock.dao";

export async function fetchRestockSuggestions(): Promise<RestockItemDAO[]> {
  ...
  // Query transaksi selesai 7 hari terakhir
  ...
  // Hitung jumlah item terjual per produk
  ...
  const suggestions: RestockItemDAO[] = [];

  // Hitung sisa stok & estimasi hari sebelum stok habis
