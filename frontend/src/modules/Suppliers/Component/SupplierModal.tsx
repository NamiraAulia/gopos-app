...
import type { SupplierDTO as Supplier, CreateSupplierPayloadDTO as CreateSupplierPayload, SalesContactDTO as CreateSupplierSalesInput } from "../DTO/suppliers.dto";

type VisitType = "taking_order" | "billing" | "both";
...
export const SupplierModal = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const { supplierDAO } = await import("../DAO/suppliers.dao");
      ...
      let res;
      if (supplierToEdit) {
        res = await supplierDAO.editSupplier(supplierToEdit.id, payload);
      } else {
        res = await supplierDAO.createSupplier(payload);
      }
