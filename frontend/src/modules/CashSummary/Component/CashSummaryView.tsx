...
import { CloseShiftModal } from "@/modules/Cashier/Component/CloseShiftModal";
import Navbar from "@/modules/Cashier/Component/Navbar";
...
const PaymentRow = ({
  ...
  <div className="flex items-center justify-between py-2.5 border-b border-slate-50 last:border-0">
    ...
    <span className="text-sm font-black text-slate-800">{formatRp(amount)}</span>
  </div>
);
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
                    ...
                    <div className="divide-y divide-slate-50">
                      {completedTrx.slice(0, 5).map((trx: any) => (
                        <div
                          key={trx.id}
