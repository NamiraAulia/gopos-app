...
import type { AuditLogDAO } from "../DAO/auditLogs.dao";
...
interface AuditLogsViewProps {
  ...
  getActionBadgeStyle: (a: string) => string;
  getFriendlyActionName: (a: string) => string;
  parseLogValue: (v: any) => string;
}
