      ...
      >
        ...
        <div className="p-3 border-t border-slate-100">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl text-red-500 hover:bg-red-50 font-bold transition-colors group relative cursor-pointer"
          >
