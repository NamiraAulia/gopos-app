...
import { kasbonApi } from "@/features/kasbon/api";
import { RepaymentModal } from "@/features/kasbon/components/RepaymentModal";
import { KasbonHistoryModal } from "@/features/kasbon/components/KasbonHistoryModal";
import type { Member } from "@/features/member/types";
import type { KasbonSummary } from "@/features/kasbon/types";
...
export default function KasbonManagementPage() {
  ...
  const [summary, setSummary] = useState<KasbonSummary>({
    total_receivables: 0,
    total_debtors: 0,
    overdue_debtors: 0,
  });
  ...
  const [selectedMemberForRepay, setSelectedMemberForRepay] = useState<Member | null>(null);
