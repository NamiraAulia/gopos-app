                    ...
                    return (
                      <tr key={product.id} className={`hover:bg-slate-50/80 transition-colors ${selectedIds.includes(product.id!) ? "bg-blue-50/30" : ""}`}>
                        ...
                        <td className="px-6 py-4 text-center">
                          <button onClick={() => handleTogglePromo(product)} className={`p-1.5 rounded-lg border text-xs transition-all cursor-pointer ${ product.is_promo ? "bg-amber-500 border-amber-600 text-white shadow-sm" : "bg-white text-slate-400 hover:bg-slate-50" }`}>
